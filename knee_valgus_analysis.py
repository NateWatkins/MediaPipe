...
def process_frames_folder(frames_dir=None):
    ...
    if frames_dir is None:
        frames_dir = "/Users/sehyr/Desktop/MediaPipe/input_videos/subject_1491D/frames/rgb"
    ...
    holistic = mp_holistic.Holistic(
        static_image_mode=False,     # IMPORTANT for per-image processing #Change To FALSE !!!!!!!!!!!!!!!!!!!!!!!!
        model_complexity=2,
        smooth_landmarks=True, # Removes jitter
        # refine_face_landmarks=True, # Adds more detail to face landmarks              // Test different cases in a report.   Overite Old output frames 
        # enable_segmentation=True, # Not used here, but can be enabled if needed
        # smooth_segmentation=True, # Not used here, but can be enabled if needed
